...
import com.example.myfirstapplication.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage() {
        ...
        message.put(Constants.KEY_MESSAGE, binding.inputMessageChat.getText().toString());
        message.put(Constants.KEY_TIMESTAMP, new Date());
        database.collection(Constants.KEY_COLLECTION_CHAT).add(message);
        if (conversionId != null) {
            updateConversion(binding.inputMessageChat.getText().toString());
            ...
            conversion.put(Constants.KEY_LAST_MESSAGE, binding.inputMessageChat.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).document(
           receiverUser.id
            ...
            if (isReceiverAvailable){
                binding.textAvailabilityChat.setVisibility(View.VISIBLE);

            }else {

                binding.textAvailabilityChat.setVisibility(View.GONE);
    ...
    private void loadReceiverDetails() {
        ...
        binding.textNameChat.setText(receiverUser.name);
    ...
    private void setListeners() {
        ...
        binding.imageBackChat.setOnClickListener(v -> onBackPressed());
        binding.layoutSendChat.setOnClickListener(v -> sendMessage());
    ...
    private void updateConversion(String message) {
        DocumentReference documentReference =
                database.collection(Constants.KEY_COLLECTION_CONVERSION).document(conversionId);
