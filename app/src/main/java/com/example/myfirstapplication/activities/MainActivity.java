...
import com.example.myfirstapplication.adapters.RecentConversionAdapter;
import com.example.myfirstapplication.databinding.ActivityMainBinding;
import com.example.myfirstapplication.listeners.ConversionListener;
...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void init() {
        ...
        binding.RecyclerViewConversion.setAdapter(conversionAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null) {
            ...
            binding.RecyclerViewConversion.smoothScrollToPosition(0);
            binding.RecyclerViewConversion.setVisibility(View.VISIBLE);
            binding.progressBarConversion.setVisibility(View.GONE);
